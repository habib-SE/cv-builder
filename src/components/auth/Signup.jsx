                    ...
                    <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form className="space-y-4 md:space-y-6" onSubmit={formik.handleSubmit}>
                            ...
                            <div className="flex justify-between gap-2 mb-4">
                                ...
                                <div className="relative w-full">
                                    <label htmlFor="confirm" className="block mb-2 text-sm font-medium text-gray-900">
                                        Confirm Password
                                    </label>
                                    <div className="relative">
                                        <input
                            ...
                            <button
                                type="submit"
                                className="inline-flex items-center justify-center px-5 py-3 w-full text-base font-medium text-center text-gray-900 border border-gray-300 rounded-lg  dark:border-gray-700  dark:focus:ring-gray-800"
                            >
                                Create Account
                            </button>
